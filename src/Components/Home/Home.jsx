...
import {  faArrowRight,faCartShopping,faTrash,faYouTube } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="home-details flex flex-col h-screen	justify-center font-serif">
                    ...
                    <div className="profile-details-name flex justify-center items-center ">
                        ...
                        <span className='my-5 before:block before:absolute before:-inset-1
                         before:-skew-y-3 before:bg-green-700 relative inline-block'>
                            <span className='text-3xl md:text-5xl relative text-white font-bold'>Mustafiz</span>
                             
                             </span>
                    </div>
                    <div className="profile-details-role text-center bg-gray-700 py-2">
                    ...
                    <div className="profile-role-tagline text-white text-center mx-10 my-5 md:mx-40">
                        <span>
